...
class WCJ_General {
    ...
    function get_settings() {
        ...
        $settings = array(
            ...
            array( 'title' => __( 'General Options', 'woocommerce-jetpack' ), 'type' => 'title', 'desc' => __( 'General.', 'woocommerce-jetpack' ), 'id' => 'wcj_general_options' ),
            
            array(
                'title'    => __( 'General', 'woocommerce-jetpack' ),
                'desc'     => __( 'Enable the General feature', 'woocommerce-jetpack' ),
                'desc_tip' => __( 'General.', 'woocommerce-jetpack' ),
